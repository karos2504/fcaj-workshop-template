...
1. **Infrastructure as Code (IaC):** Sử dụng **AWS SAM (Serverless Application Model)** để định nghĩa và quản lý tự động toàn bộ 18+ tài nguyên AWS qua mã lệnh (`template.yaml`).

...
* Nguồn tham khảo: [AWS Storage Blog - Enable item-level search and recovery for Amazon EC2 with AWS Backup](https://aws.amazon.com/blogs/storage/enable-item-level-search-and-recovery-for-amazon-ec2-with-aws-backup/)
